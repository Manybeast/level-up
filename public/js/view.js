var View = (function () {
    ...
    View.prototype.renderOne = function (item) {
       ...
       templ = defaultTemplate.replace('{{complited}}', item.complited);
       templ = defaultTemplate.replace('{{checked}}', item.checked);
       templ = defaultTemplate.replace('{{title}}', item.title);
